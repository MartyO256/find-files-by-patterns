...
describe("path", () => {
  describe("ofBasename", () => {
    it("returns `false` if no base names are given", () => {
    ...
    describe("(...tests: string[]): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's base name matches a string base name", () => {
        assert.isTrue(ofBasename("file.md")("/home/user/file.md"));
      });
      it("returns `false` if a path's base name does not match a string base name", () => {
    ...
    describe("(...tests: RegExp[]): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's base name matches a regular expression pattern", () => {
        const filter = ofBasename(/^file\..*$/);
        assert.isTrue(filter("/home/user/file.md"));
        assert.isTrue(filter("/home/user/file.html"));
      });
      it("returns `false` if a path's base name does not match a regular expression pattern", () => {
    ...
    describe("(...tests: Array<((basename: string) => boolean)>): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's base name matches a function", () => {
        const filter = ofBasename(() => true);
        assert.isTrue(filter("/home/user/file.md"));
      });
      it("returns `false` if a path's base name does not match a function", () => {
        const filter = ofBasename(() => false);
        assert.isFalse(filter("/home/user/file.md"));
      });
      it("throws an error if a test function throws an error", () => {
    ...
    describe("(...tests: Array<string | RegExp | ((basename: string) => boolean)>): FilterSync<string>", () => {
      ...
      it("arbitrarily returns `false` if no base names are given", () => {
        const basenames: Array<
          string | RegExp | ((basename: string) => boolean)
        > = [];
        assert.isFalse(ofBasename(...basenames)(""));
      });
      it("returns `true` if a path's base name matches", () => {
        assert.isTrue(filter("/home/user/file.md"));
      });
      it("returns `false` if a path's base name does not match", () => {
  ...
  describe("ofName", () => {
    ...
    describe("(...tests: string[]): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's name matches a string name", () => {
        assert.isTrue(ofName("file")("/home/user/file.md"));
      });
      it("returns `false` if a path's name does not match a string name", () => {
    ...
    describe("(...tests: RegExp[]): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's name matches a regular expression pattern", () => {
        const filter = ofName(/^file.*$/);
        assert.isTrue(filter("/home/user/files.md"));
        assert.isTrue(filter("/home/user/files.html"));
      });
      it("returns `false` if a path's name does not match a regular expression pattern", () => {
    ...
    describe("(...tests: Array<((basename: string) => boolean)>): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's name matches a function", () => {
        const filter = ofName(() => true);
        assert.isTrue(filter("/home/user/file.md"));
      });
      it("returns `false` if a path's name does not match a function", () => {
    ...
    describe("(...tests: Array<string | RegExp | ((basename: string) => boolean)>): FilterSync<string>", () => {
      ...
      it("returns `false` if a path's name does not match", () => {
        assert.isFalse(filter("/home/user/no-file.md"));
      });
      it("throws an error if a test function throws an error", () => {
  ...
  describe("ofDirname", () => {
    it("arbitrarily returns `false` if no directory names are given", () => {
    ...
    describe("(...tests: string[]): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's directory name matches a string directory name", () => {
        assert.isTrue(
          ofDirname("/home/user/directory")("/home/user/directory/file.md"),
        );
      });
      it("returns `false` if a path's directory name does not match a string directory name", () => {
        assert.isFalse(
    ...
    describe("(...tests: RegExp[]): FilterSync<string>", () => {
      it("returns `false` if no directory names are given", () => {
        const dirnames: RegExp[] = [];
        assert.isFalse(ofDirname(...dirnames)(""));
      });
      it("returns `true` if a path's directory name matches a regular expression pattern", () => {
      ...
      it("returns `false` if a path's directory name does not match a regular expression pattern", () => {
    ...
    describe("(...tests: Array<((dirname: string) => boolean)>): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's dirname name matches a function", () => {
        const filter = ofDirname(() => true);
        assert.isTrue(filter("/home/user/directory/file.md"));
      });
      it("returns `false` if a path's directory name does not match a function", () => {
    ...
    describe("(...tests: Array<string | RegExp | ((dirname: string) => boolean)>): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's directory name matches", () => {
        assert.isTrue(filter("/home/user/directory/file.md"));
      });
      it("returns `false` if a path's directory name does not match", () => {
  ...
  describe("ofExtname", () => {
    it("returns `false` if no extension names are given", () => {
    ...
    describe("(...tests: string[]): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's extension name matches a string extension name", () => {
        assert.isTrue(ofExtname(".md")("/home/user/file.md"));
      });
      it("returns `false` if a path's extension name does not match a string extension name", () => {
    ...
    describe("(...tests: RegExp[]): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's extension name matches a regular expression pattern", () => {
        const filter = ofExtname(/^\.md$/);
        assert.isTrue(filter("/home/user/file.md"));
      });
      it("returns `false` if a path's extension name does not match a regular expression pattern", () => {
    ...
    describe("(...tests: Array<((extname: string) => boolean)>): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's extension name matches a function", () => {
        const filter = ofExtname(() => true);
        assert.isTrue(filter("/home/user/file.md"));
      });
      it("returns `false` if a path's extension name does not match a function", () => {
    ...
    describe("(...tests: Array<string | RegExp | ((extname: string) => boolean)>): FilterSync<string>", () => {
      ...
      it("returns `true` if a path's extension name matches", () => {
        assert.isTrue(filter("/home/user/file.md"));
      });
      it("returns `false` if a path's extension name does not match", () => {
  ...
  describe("firstSegmentPosition", () => {
    ...
    it("skips segments consisting of special characters only", () => {
      const firstPositions = new Map<string, number>([
        [join("."), -1],
        [join(".."), -1],
        [join("..", ".."), -1],
  ...
  describe("segments", () => {
    it("yields the correct segments", () => {
  ...
  describe("hasPathSegments", () => {
    it("is false if there are no tests", () => {
    ...
    it("is true if all path segments pass the tests", () => {
      assert.isTrue(
    ...
    it("is false if any path segment fails the tests", () => {
      assert.isFalse(
        hasPathSegments((segment) => !segment.startsWith("_"))(
          "./_folder/file.html",
        ),
    ...
    it("normalizes and trim paths to extract the path segments to test", () => {
      assert.isTrue(
        hasPathSegments((segment) => !segment.startsWith("_"))(
          "./../folder/./file.html/././//",
        ),
