import { AsynchronousFileFinder, SynchronousFileFinder } from "./fileFinder";
 ...
 * @since 0.1.0
 */
export interface SynchronousStrictFileFinder extends SynchronousFileFinder {
  /**
 ...
 * @since 0.1.0
 */
export interface AsynchronousStrictFileFinder extends AsynchronousFileFinder {
  /**
 ...
 * @since 0.1.0
 */
export interface StrictFileFinder extends AsynchronousStrictFileFinder {
  sync: SynchronousStrictFileFinder;
}
